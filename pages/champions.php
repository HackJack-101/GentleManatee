		...
		foreach ($champions_data as $id => $champion)
		{
			...
			<tr>
				...
				<td class="maxDamageDealt">
					...
					<br/>
					<progress value="0" data-value="<?php echo $champion->maxTotalDamageDealtToChampions ?>" 
				...
				<td class="averageTotalDamageDealt">
					...
					<br/>
					<progress value="0" data-value="<?php echo $averageTotalDamageDealtToChampions; ?>" 
				...
				<td class="maxDamageTaken">
					...
					<br/>
					<progress value="0" data-value="<?php echo $champion->maxTotalDamageTaken ?>" 
				...
				<td class="maxInhibitorKills">
					...
					<br/>
					<progress value="0" data-value="<?php echo $champion->maxInhibitorKills ?>" 
				...
				<td class="averageInhibitorKills">
					...
					<br/>
					<progress value="0" data-value="<?php echo $averageCumulatedInhibitorKills; ?>" 
							  max="<?php echo $stats->maxValues['averageCumulatedInhibitorKills'] ?>"></progress>
				</td>
				<td class="matchs">
					<?php echo $champion->played ?>
					<br/>
					<progress value="0" data-value="<?php echo $champion->played ?>" 
							  max="<?php echo $stats->maxValues['played'] ?>"></progress>
				</td>
				<td class="bans">
					<?php echo $totalBans; ?>
					<br/>
					<progress value="0" data-value="<?php echo $totalBans ?>" 
